...
$.extend(true, $.fn.dataTable.defaults, {
    "sDom": "t<'row DTTTFooter'<'col-sm-6'lis><'col-sm-6'p>>",
    "language": {
        "search": "",
        "sLengthMenu": "_MENU_",
        "oPaginate": {
        ...
        "infoEmpty": "",
        "emptyTable": '<div class="tc">暂无记录</div>',
        "zeroRecords": ""
    },
    select: {
        style: 'multi'
...
$.extend($.fn.dataTableExt.oStdClasses, {
    ...
    "sLengthSelect": "form-control input-sm input-inline"
});
...
/* Bootstrap style none number pagination control */
$.extend($.fn.dataTableExt.oPagination, {
    "bootstrap_none_number": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            var oLang = oSettings.oLanguage.oPaginate;
            var fnClickHandler = function (e) {
                e.preventDefault();
