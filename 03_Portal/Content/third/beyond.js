...
$(function () {
    ...
    //topbar
    var $nav_li = $(".top-bar>.top-menu>li");
    $nav_li.on('mouseenter', function () {
        $(this).find('.sec-menu').show();
    }).on('mouseleave', function () {
        $(this).find('.sec-menu').hide();
    });
    //end topbar
});
...
function InitiateWidgets() {
    ...
    $('.widget-buttons *[data-toggle="collapse"]').on("click", function (event) {
        ...
        if (widget.hasClass("collapsed")) {
            if (button) {
                button.addClass(up).removeClass(down).prop('title', '折叠');
            }
    ...
    $("span.input-group-addon").on("click", function () {
        if ($(this).children("i").hasClass("fa-calendar")) {
