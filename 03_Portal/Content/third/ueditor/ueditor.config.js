...
(function () {
     ...
     */
    var URL_UPLOAD = "http://localhost:31956/Upload/UploadUeditor"
    var DEFAULT_URL = window.UEDITOR_HOME_URL || getUEBasePath();
    var URL = "/content/third/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: URL_UPLOAD

        , configUrl: DEFAULT_URL + "net/controller.ashx"
        ...
        , labelMap: {
            ...
            , 'inserttable': '插入表格'
            , 'deletetable': '删除表格'
            , 'insertparagraphbeforetable': '表格上方插入行'
            , 'insertrow': '插入行'
            , 'deleterow': '删除行'
            , 'insertcol': '插入列'
            , 'deletecol': '删除列'
            ...
            , 'redo': '重做'
            , 'preview': '预览'
            , 'print': '打印', 'source': '切换源码，注意保存时请切换回涉及模式！'
        }
        ...
        , zIndex: 150     //编辑器层级的基数,默认是900(fixed:不能超过200，头部的Nav var的Z-index是200)
